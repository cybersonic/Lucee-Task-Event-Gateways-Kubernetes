...
<cfLuceeConfiguration hspw="" salt="12FB74C3-69CD-4348-A839A29127ED8B7C" version="4.5">
	<cfabort />
...
for every argument defined lucee tries to call a matching setter method
 ...
 -->
	...
	<rest />
	<gateways>
		<gateway cfc-path="org.lucee.cfml.TasksGateway" custom="checkForChangeNoMatchInterval=60&amp;logName=application&amp;templatePath=%2Ftaskrunners_cfm&amp;checkForChangeInterval=10&amp;package=taskrunners" id="taskrunners" listener-cfc-path="" read-only="false" startup-mode="automatic" />
	</gateways>
	<orm />
	<cache>
		<connection class="lucee.extension.io.cache.redis.simple.RedisCache" custom="secretKey=&amp;minIdle=0&amp;maxTotal=24&amp;secretName=&amp;maxIdle=8&amp;maxLowPriority=0&amp;host={env:REDIS_SERVER_LOCAL_SERVICE_HOST}&amp;accessKeyId=&amp;idleTimeout=300000&amp;password=&amp;liveTimeout=3600000&amp;region=&amp;port={env:REDIS_SERVER_LOCAL_SERVICE_PORT}&amp;timeToLiveSeconds=0&amp;socketTimeout=2000&amp;username=&amp;connectionTimeout=5000" name="redisqueue" read-only="false" storage="false" />
	</cache>
